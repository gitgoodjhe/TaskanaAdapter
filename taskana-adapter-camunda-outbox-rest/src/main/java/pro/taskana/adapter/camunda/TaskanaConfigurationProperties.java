  ...
  public static Duration getDurationBetweenTaskCreationRetries() {
    ...
    if (durationBetweentaskCreationRetriesProperty == null
      ...
      try {
        ...
        LOGGER.warn(
            String.format(
                "Attempted to retrieve duration between task creation retries and caught "
                    + "Exception. Setting default to %s ",
  ...
  public static int getInitialNumberOfTaskCreationRetries() {
    ...
    if (maxNumberOfEventsString == null || maxNumberOfEventsString.isEmpty()) {
      ...
      try {
        ...
        LOGGER.warn(
            String.format(
                "Attempted to retrieve initial number of task creation retries "
                    + "and caught Exception. "
                    + "Setting default for initial number of task creation retries to %d  ",
