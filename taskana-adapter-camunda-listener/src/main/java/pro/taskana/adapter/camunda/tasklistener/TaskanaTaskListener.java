...
public class TaskanaTaskListener implements TaskListener, TaskanaConfigurationProperties {
  ...
  private static final String SQL_INSERT_EVENT =
      "INSERT INTO event_store (TYPE,CREATED,PAYLOAD,REMAINING_RETRIES,BLOCKED_UNTIL) VALUES (?,?,?,?,?)";
  ...
  private void prepareAndExecuteStatement(
    ...
    try (PreparedStatement preparedStatement =
      ...
      int maxRetries = Integer.parseInt(ReadPropertiesHelper.getPropertyValueFromFile(
          TASKANA_OUTBOX_PROPERTIES,TASKANA_ADAPTER_OUTBOX_MAX_NUMBER_OF_TASK_CREATION_RETRIES));
